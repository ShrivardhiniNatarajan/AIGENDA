...
genai.configure(api_key="AIzaSyBfkpAQ-qYxfJaIyhfnmJ7bikoPVEWuJoE")
...
st.sidebar.write("Made by Shrivardhini")
st.sidebar.write("Powered by Google Gemini AI")
st.header("RoboBill")
st.subheader("Made by Shrivardhini")
st.subheader("Manage your expenses with the Robobill")
...
input_prompt="""
You are an expert in reading invoices.We are going to upload an image of an image 
